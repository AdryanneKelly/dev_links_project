<div class="h-screen w-full bg-gradient-to-r from-purple-700 via-blue-500 to-cyan-500">
    <div class="flex flex-row h-[95%] max-sm:flex sm:flex max-sm:flex-col sm:flex-col lg:flex-row">
        <div
            class="flex flex-col justify-center gap-5 h-full lg:h-full w-1/2 lg:w-1/2 max-sm:w-full sm:w-full sm:h-1/2 px-[10%] text-white">
            <h2
    ...
    <div class="flex flex-col justify-center text-center items-center h-[5%] bg-purple-700">
